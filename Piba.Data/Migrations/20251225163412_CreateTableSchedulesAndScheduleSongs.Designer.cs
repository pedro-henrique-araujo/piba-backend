...
namespace Piba.Data.Migrations
{
    ...
    [Migration("20251225163412_CreateTableSchedulesAndScheduleSongs")]
    partial class CreateTableSchedulesAndScheduleSongs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Piba.Data.Entities.Link", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Piba.Data.Entities.PibaUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Piba.Data.Entities.Schedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Piba.Data.Entities.ScheduleSong", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Piba.Data.Entities.Song", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Piba.Data.Entities.PibaUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Piba.Data.Entities.Link", b =>
                {
                    b.HasOne("Piba.Data.Entities.Song", "Song")
                        .WithMany("Links")
            ...
            modelBuilder.Entity("Piba.Data.Entities.ScheduleSong", b =>
                {
                    b.HasOne("Piba.Data.Entities.Schedule", "Schedule")
                        .WithMany("ScheduleSongs")
